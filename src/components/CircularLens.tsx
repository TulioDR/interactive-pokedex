...
export default function CircularLens({ status = true, isOn = true }: Props) {
  return (
    <div className=" h-12 aspect-square relative group/lens">
      <div className="w-12 h-12 rounded-full bg-slate-900 border-4 border-slate-200 flex items-center justify-center overflow-hidden">
        <div
          className={`w-8 h-8 rounded-full relative duration-1000 ${
            isOn
              ? "bg-linear-to-br from-cyan-400 to-blue-600 animate-pulse "
              : "bg-linear-to-br from-black to-black"
          }  `}
        >
          {/* Lens glint */}
