import BaseStat from "@/features/pokedex/components/PokedexScreen/PokedexData/DataTabs/Tabs/Stats/BaseStat";
  ...
  return (
    <SectionContainer className="sm:col-span-2">
      <SectionTitle icon="monitoring" title="Base Stats">
        <div className="font-bold uppercase text-xs">BST : {baseStatTotal}</div>
      </SectionTitle>
